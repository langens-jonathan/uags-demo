...
public class UpdateBlockStatement extends BlockStatement
{
    ...
    public UpdateBlockStatement(BLOCKTYPE type, SplitQuery.SplitQueryIterator iterator, String graph)
    {
        ...
        while (iterator.hasNextIncludingNewLines()) {
            ...
            if (iterator.peekNext().startsWith("}")) {
                ...
                if(iterator.hasNext() && iterator.peekNext().toLowerCase().startsWith("insert"))
                {
                    ...
                    UpdateBlockStatement deleteStatement = new UpdateBlockStatement(BLOCKTYPE.DELETE, iterator, this.getGraph());
                ...
                if(this.type.equals(BLOCKTYPE.DELETE_INSERT))
                {
                    ...
                    UpdateBlockStatement insertBlock = new UpdateBlockStatement(BLOCKTYPE.INSERT, iterator, this.getGraph());
            ...
            statements.addAll(SimpleStatement.generateSimpleStatementList(iterator));
